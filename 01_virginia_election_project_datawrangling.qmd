...
All data for the Virginia gubernatorial elections can be found here: <https://historical.elections.virginia.gov/elections/view/144567/> 

Then, we just clean up the columns, and process the data. I've decided to label the file 'prez_2020.'
...
Using the head function, the next step is to check out what data we have.
...
In order to calculate what percentage of the vote each presidential candidate got, we have to create a new column using the 'mutate' function. The formula for how to do this can be found below.
...
For ease of readability, it's important to move the decimal point two places over.
